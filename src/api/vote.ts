...
export const createVote = async (input: CreateVoteInput): Promise<ApiResponse<Vote>> => {
  try {
 ...
 */
export const deleteVote = async (input: CreateVoteInput): Promise<ApiResponse<Vote>> => {
  try {
    const userId = getAnonymousUserId()
...
export const getVoteCountByPartyId = async (partyId: number): Promise<ApiResponse<number>> => {
  try {
 ...
 */
export const checkUserVote = async (partyId: number, userId?: string): Promise<ApiResponse<boolean>> => {
  try {
